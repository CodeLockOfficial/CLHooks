...
[System.Windows.Forms.Application]::EnableVisualStyles()
    ...
    if ($result -eq [System.Windows.Forms.DialogResult]::OK)
    {
        ...
        try {
            $response = Invoke-RestMethod -Uri 'https://api.codelock.ai/api/v1/verify-hook' -Method POST -Body $jsonBody -ContentType 'application/json'
    ...
    $otpResponse = Invoke-RestMethod -Uri 'https://api.codelock.ai/api/v1/verify-hook-otp' -Method POST -Body $otpJson -ContentType 'application/json'
    if ($otpResponse.code -eq 0) {
        ...
        # Trigger the hook
        $hookTriggerResponse = Invoke-RestMethod -Uri 'https://api.codelock.ai/api/v1/trigger-git-hook' -Method POST -Body $hookTriggerJson -ContentType 'application/json'
